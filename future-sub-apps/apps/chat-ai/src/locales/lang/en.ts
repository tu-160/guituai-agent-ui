export default {
  application: {
    title: 'GuituAI',
    desctiption: 'Help you find inspiration',
  },
  chat_index: {
    ...
    recommendation: 'Intelligent Agent Recommendation',
    tryEntering: 'You can try entering',
    agentDialog: 'Intelligent dialogue',
    enterQuestion: 'Enter your question or request',
    wonderfulStart: '🌗 At dawn, may you have a wonderful start!',
  ...
  common: {
    tip_title: 'tip',
    quitsys: 'Are you sure you want to exit the system?',
    confirm: 'confirm',
  ...
  login: {
    ...
    description: 'Sign up explore top RAG technology. Create knowledge bases and AIs to empower your business.',
    review: '',
    wechatLogin: 'Welcome to login with WeChat.',
    wechatQR: 'Please use your mobile phone to scan the QR code to login via WeChat.',
  ...
  knowledgeDetails: {
    ...
    namePlaceholder: 'Please input name!',
    doc: 'Docs',
    datasetDescription: '😉 Please wait for your file to finish parsing before starting an AI-powered chat.',
    addFile: 'Add file',
    ...
    testingDescription: 'Conduct a retrieval test to check if GuituAI can recover the intended content for the LLM.',
    similarityThreshold: 'Similarity threshold',
    similarityThresholdTip:
      'GuituAI employs either a combination of weighted keyword similarity and weighted vector cosine similarity, or a combination of weighted keyword similarity and weighted reranking score during retrieval. This parameter sets the threshold for similarities between the user query and chunks. Any chunk with a similarity score below this threshold will be excluded from the results.',
    ...
    pageRangesTip: 'Range of pages to be parsed; pages outside this range will not be processed.',
    ...
    greaterThanPrevious: 'The current value must be greater than the previous to!',
    selectFiles: 'Select files',
    changeSpecificCategory: 'Change specific category',
    uploadTitle: 'Click or drag file to this area to upload',
    uploadDescription: 'Support for a single or bulk upload. Strictly prohibited from uploading company data or other banned files.',
    chunk: 'Chunk',
    bulk: 'Bulk',
    cancel: 'Cancel',
    rerankModel: 'Rerank model',
    rerankPlaceholder: 'Please select',
    rerankTip: `If left empty, GuituAI will use a combination of weighted keyword similarity and weighted vector cosine similarity; if a rerank model is selected, a weighted reranking score will replace the weighted vector cosine similarity.`,
    topK: 'Top-K',
  ...
  knowledgeConfiguration: {
    titleDescription: 'Update your knowledge base configuration here, particularly the chunk method.',
    ...
    permissionsTip: "If set to 'Team', all team members will be able to manage the knowledge base.",
    chunkTokenNumberTip:
    ...
    methodExamplesDescription: 'The following screenshots are provided for clarity.',
    dialogueExamplesTitle: 'Dialogue examples',
    methodEmpty: 'This will display a visual explanation of the knowledge base categories',
    chunkGeneral: 'General',
    chunkQA: 'Q&A',
    chunkResume: 'Resume',
    chunkManual: 'Manual',
    chunkTable: 'Table',
...
<p>Ensure that you set the <b>Entity types</b>.</p>`,
    ...
    useRaptorTip: 'Recursive Abstractive Processing for Tree-Organized Retrieval, see https://huggingface.co/papers/2401.18059 for more information.',
    prompt: 'Prompt',
...
The above is the content you need to summarize.`,
  ...
  chat: {
    ...
    chatConfigurationDescription: ' Set up a chat assistant dedicated to your selected knowledge bases here! 💕',
    ...
    systemTip: 'Your prompts or instructions for the LLM, including but not limited to its role, the desired length, tone, and language of its answers.',
    topN: 'Top N',
    ...
    presencePenaltyTip: 'This discourages the model from repeating the same information by penalizing words that have already appeared in the conversation.',
    frequencyPenalty: 'Frequency penalty',
    frequencyPenaltyMessage: 'Frequency penalty is required',
    frequencyPenaltyTip: 'Similar to the presence penalty, this reduces the model’s tendency to repeat the same words frequently.',
    ...
    fullScreenDescription: 'Embed the following iframe into your website at the desired location',
    partialTitle: 'Partial Embed',
    extensionTitle: 'Chrome Extension',
    tokenError: 'Please create API Token first!',
    betaError: 'Please acquire a Guituai API key from the System Settings page first.',
    searching: 'Searching...',
    parsing: 'Parsing',
    uploading: 'Uploading',
    ...
    read: 'Read content',
    tts: 'Text to speech',
    ttsTip: 'Ensure you select a TTS model on the Settings page before enabling this toggle to play text as audio.',
    relatedQuestion: 'Related question',
    answerTitle: 'R',
    multiTurn: 'Multi-turn optimization',
    multiTurnTip: 'This optimizes user queries using context in a multi-round conversation. When enabled, it will consume additional LLM tokens.',
    howUseId: 'How to use chat ID?',
    description: 'Description of assistant',
    imageSize: 'The image size must not exceed 500k!',
    editingAgent: 'Editing Agent',
    basicInformation: 'Basic Information',
    presetQuestions: 'Preset questions',
    instructions: 'Intelligent agent instructions',
    intelligentParameters: 'Intelligent agent parameters',
    debugging: 'Debugging and Preview',
  },
  setting: {
    profile: 'Profile',
    ...
    maxTokensMinMessage: 'Max Tokens cannot be less than 0.',
    password: 'Password',
    passwordDescription: 'Please enter your current password to change your password.',
    ...
    newPasswordDescription: 'Your new password must be more than 8 characters.',
    confirmPassword: 'Confirm new password',
    confirmPasswordMessage: 'Please confirm your password!',
    confirmPasswordNonMatchMessage: 'The new password that you entered do not match!',
    cancel: 'Cancel',
    addedModels: 'Added models',
    modelsToBeAdded: 'Models to be added',
    addTheModel: 'Add the model',
    apiKey: 'API-Key',
    apiKeyMessage: 'Please enter the API key (for locally deployed model,ignore this).',
    apiKeyTip: 'The API key can be obtained by registering the corresponding LLM supplier.',
    showMoreModels: 'Show more models',
    baseUrl: 'Base-Url',
    baseUrlTip: 'If your API key is from OpenAI, just ignore it. Any other intermediate providers will give this base url with the API key.',
    modify: 'Modify',
    systemModelSettings: 'System Model Settings',
    chatModel: 'Chat model',
    chatModelTip: 'The default chat LLM all the newly created knowledgebase will use.',
    embeddingModel: 'Embedding model',
    embeddingModelTip: 'The default embedding model all the newly created knowledgebase will use.',
    img2txtModel: 'Img2txt model',
    img2txtModelTip: 'The default multi-module model all the newly created knowledgebase will use. It can describe a picture or video.',
    sequence2txtModel: 'Sequence2txt model',
    sequence2txtModelTip: 'The default ASR model all the newly created knowledgebase will use. Use this model to translate voices to corresponding text.',
    rerankModel: 'Rerank model',
    rerankModelTip: `The default rerank model is used to rerank chunks retrieved by users' questions.`,
    ttsModel: 'TTS Model',
    ttsModelTip: 'The default TTS model will be used to generate speech during conversations upon request.',
    workspace: 'Workspace',
    upgrade: 'Upgrade',
    addLlmTitle: 'Add LLM',
    ...
    FishAudioModelNameMessage: 'Please give your speech synthesis model a name',
    addFishAudioAK: 'Fish Audio API KEY',
    addFishAudioAKMessage: 'Please input your API KEY',
    addFishAudioRefID: 'FishAudio Refrence ID',
    addFishAudioRefIDMessage: 'Please input the Reference ID (leave blank to use the default model).',
    ...
    addGoogleServiceAccountKey: 'Service Account Key(Leave blank if you use Application Default Credentials)',
    GoogleServiceAccountKeyMessage: 'Please input Google Cloud Service Account Key in base64 format',
  ...
  message: {
    ...
    updated: 'Updated',
    uploaded: 'Uploaded',
    pleaseUploaded: 'Please select a file to upload',
    ...
    networkAnomalyDescription: 'There is an abnormality in your network and you cannot connect to the server.',
  ...
  fileManager: {
    ...
    uploadLimit: 'The file size cannot exceed 10M, and the total number of files cannot exceed 128',
    destinationFolder: 'Destination folder',
  },
  flow: {
    createAdvanced: 'Create advanced intelligent agents',
    flow: 'workflow',
    cite: 'Cite',
    citeTip: 'Reference the historical context.',
    name: 'Name',
    nameMessage: 'Please input name',
    nameExisted: 'The name already exists, please re-enter the name!',
    description: 'Description',
    examples: 'Examples',
    to: 'To',
    msg: 'Messages',
  ...
  The above is the content you need to summarize.`,
    ...
    email: 'Email',
    emailTip: 'E-mail is a required field. You must input an E-mail address here.',
    arXiv: 'ArXiv',
    arXivDescription:
    ...
    googleScholarDescription: 'A component that searches https://scholar.google.com/. You can use Top N to specify the number of search results.',
    yearLow: 'Year low',
    yearHigh: 'Year high',
    patents: 'Patents',
    data: 'Data',
    deepL: 'DeepL',
    deepLDescription: 'A component that gets more specialized translations from https://www.deepl.com/.',
    authKey: 'Auth key',
    sourceLang: 'Source language',
    targetLang: 'Target language',
    gitHub: 'GitHub',
    gitHubDescription: 'A component that searches for repositories from https://github.com/. You can use Top N to specify the number of search results.',
    baiduFanyi: 'BaiduFanyi',
    baiduFanyiDescription: 'A component that gets specialized translations from https://fanyi.baidu.com/.',
    appid: 'App id',
    ...
    qWeather: 'QWeather',
    qWeatherDescription: 'A component that retrieves weather information, such as temperature and air quality, from https://www.qweather.com/.',
    lang: 'Language',
    type: 'Type',
    ...
    publish: 'API',
    exeSQL: 'ExeSQL',
    exeSQLDescription: 'A component that performs SQL queries on a relational database, supporting querying from MySQL, PostgreSQL, or MariaDB.',
    ...
    wenCaiDescription: 'A component that obtains financial information, including stock prices and funding news, from a wide range of financial websites.',
    ...
    akShare: 'AkShare',
    akShareDescription: 'A component that obtains news about stocks from https://www.eastmoney.com/.',
    yahooFinance: 'YahooFinance',
    yahooFinanceDescription: 'A component that queries information about a publicly traded company using its ticker symbol.',
    crawler: 'Web Crawler',
    crawlerDescription: 'A component that crawls HTML source code from a specified URL.',
    proxy: 'Proxy',
    ...
    concentratorDescription: 'A component that receives the output from the upstream component and passes it on as input to the downstream components.',
    tuShare: 'TuShare',
    tuShareDescription: 'A component that obtains financial news briefs from mainstream financial websites, aiding industry and quantitative research.',
    tuShareSrcOptions: {
      sina: 'Sina',
    ...
    noteDescription2: 'This component is only used as an annotation tag and does not participate in calculations.',
    ...
    cleanHtmlTip: 'If the response is HTML formatted and only the primary content wanted, please toggle it on.',
    reference: 'Reference',
    input: 'Input',
    output: 'Output',
    parameter: 'Parameter',
    ...
    testRun: 'Test Run',
    template: 'Template',
    templateDescription: 'A component that formats the output of another component.',
    ...
    jsonFormatTip: 'Upstream component should provide JSON string in following format:',
    ...
    notConnectedTip: 'These nodes {nodes} cannot be used as its next step.',
  },
  footer: {
