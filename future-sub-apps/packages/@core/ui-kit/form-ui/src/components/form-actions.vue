...
import { useSimpleLocale } from '@future-core/composables';
import { VbenExpandableArrow } from '@future-core/shadcn-ui';
import { cn, isFunction, triggerWindowResize } from '@future-core/shared/utils';
