...
import { Form } from '@future-core/shadcn-ui';
import { cn, isString, mergeWithArrayOverride } from '@future-core/shared/utils';
...
const computedSchema = computed((): ({ commonComponentProps: Record<string, any> } & FormSchema)[] => {
  const {
    componentProps = {},
    controlClass = '',
    disabled,
