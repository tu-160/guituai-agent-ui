...
import type { TabDefinition } from '@future-core/typings';

import type { TabConfig, TabsProps } from '../../types';

import { computed } from 'vue';

import { Pin, X } from '@future-core/icons';
import { VbenContextMenu, VbenIcon } from '@future-core/shadcn-ui';
import { deepToRaw } from '@future-core/shared/utils';
